...
namespace Vanalytics.Data.Migrations
{
    ...
    [Migration("20260420153058_AddForumCategoryAdminThreadFlag")]
    partial class AddForumCategoryAdminThreadFlag
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Soverance.Forum.Models.ForumCategory", b =>
                {
                    ...
                    b.Property<bool>("RequiresAdminForNewThreads")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.SynthRecipe", b =>
                {
                    ...
                    b.Property<int>("CrystalItemId")
                        .HasColumnType("int");

                    b.Property<int>("Gold")
                        .HasColumnType("int");

                    b.Property<int?>("HqCrystalItemId")
                        .HasColumnType("int");

                    b.Property<bool>("IsDesynth")
                        .HasColumnType("bit");

                    b.Property<int>("Leather")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq1ItemId")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq1Qty")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq2ItemId")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq2Qty")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq3ItemId")
                        .HasColumnType("int");

                    b.Property<int?>("ResultHq3Qty")
                        .HasColumnType("int");

                    b.Property<int>("ResultItemId")
                        .HasColumnType("int");

                    b.Property<int>("ResultQty")
                        .HasColumnType("int");

                    b.Property<int>("Smith")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ContentTag");

                    b.HasIndex("IsDesynth");
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.MacroBookSnapshot", b =>
                {
                    b.HasOne("Vanalytics.Core.Models.MacroBook", "MacroBook")
                        .WithMany("Snapshots")
                        .HasForeignKey("MacroBookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MacroBook");
                });
            ...
            modelBuilder.Entity("Vanalytics.Core.Models.RecipeIngredient", b =>
                {
                    b.HasOne("Vanalytics.Core.Models.SynthRecipe", null)
